...
sudo ln -f -s /var/www/rank/misc/systemd.service /etc/systemd/system/rank.service
sudo ln -f -s /var/www/rank/misc/systemd.timer /etc/systemd/system/rank.timer
